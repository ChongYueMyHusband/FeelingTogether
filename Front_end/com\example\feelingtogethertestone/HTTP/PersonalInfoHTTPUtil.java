...
public class PersonalInfoHTTPUtil {
    ...
    public static String sendPost(String account, String password, String userName, String age, String sex, String idiograph, String headPortraitBase64Code) {
        String result = "";
        try {
            String path = "http://101.200.84.147:8081/PersonalInfo";
            ...
            jsonData.put("gender", sex);
            jsonData.put("userIdiograph", idiograph);
            jsonData.put("headPortraitBase64Code", headPortraitBase64Code);
            String data = jsonData.toString();
            Log.i("Personalinfo", data);
            // {"account":"2387171466","password":"fan123123","username":"null111","age":"0","gender":"null1","userIdiograph":"null111","headPortraitBase64Code":""}
