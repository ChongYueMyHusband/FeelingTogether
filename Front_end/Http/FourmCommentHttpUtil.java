...
public class FourmCommentHttpUtil{
    private static final String TAG = "FourmContentHttpUtil";
    /**
     * 向指定 URL 发送POST方法的请求
     *
    ...
    public static String sendPost(String user_account, String id,String content) {
        String result = "";
        try {
            String path = "http://101.200.84.147:8081/Remark";
