...
public class FourmLikeHttpUtil {
    private static final String TAG = "FourmLikeHttpUtil";

    public static String sendPost(String username,String id) {
        String result = "";
        try {
            String path = "http://101.200.84.147:8081/like";
            ...
            jsonData.put("user_account", username);
            jsonData.put("id",id);
