...
public class FacialCollectHTTPUtil  {

    private static final String TAG = "FacialCollectHTTPUtil";

    /**
     * 向指定 URL 发送POST方法的请求
     *
     * @param username 账号
     * @param pictureBase64Code 拍照照片的Base64编码
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String username, String pictureBase64Code) {
        String result = "";
        try {
            String path = "http://101.200.84.147:8081/updateFace";
            ...
            jsonData.put("headPortraitBase64Code", pictureBase64Code);
