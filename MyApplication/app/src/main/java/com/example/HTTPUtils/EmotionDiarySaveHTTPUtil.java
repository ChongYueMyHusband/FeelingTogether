...
public class EmotionDiarySaveHTTPUtil {

    private static final String TAG = "EmotionDiarySaveHTTPUtil";

    /**
     * 向指定 URL 发送POST方法的请求
     * @param diaryContent 密码
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String diaryContent) {
        String result = "";
        try {
            String path = "http://101.200.84.147:8081/Diary";
            ...
            jsonData.put("content", diaryContent);
            String data = jsonData.toString();
            // 正常打印：{"content":"为什么我给他发东西他收不到"}
            Log.i("EmotionDiaryActivity123", data);
