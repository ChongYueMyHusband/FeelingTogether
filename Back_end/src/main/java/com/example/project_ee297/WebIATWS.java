...
public class WebIATWS extends WebSocketListener {
	...
	private static final String appid = "c42a8fc5"; //在控制台-我的应用获取
	private static final String apiSecret = "NDRkOGEwYWQwMzkwYTM2OTc2M2RmODYx"; //在控制台-我的应用-语音听写（流式版）获取
	private static final String apiKey = "1389aa5d53e53ae7578609062dffe3b9"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String file = "D:\\download\\iat_mp3_16k.mp3"; // 中文
